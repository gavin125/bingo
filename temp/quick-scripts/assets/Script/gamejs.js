(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/gamejs.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '2933d+A/jtAgaqK+ueNu8kz', 'gamejs', __filename);
// Script/gamejs.js
...
cc.Class({
		...
		onLoad: function onLoad() {
				...
				if (Math.ceil(this.num / 2) > 1) {
						for (var _i = 1; _i <= Math.ceil(this.num / 2); _i++) {
								...
								if (_i == 1) {
										newTabbar.getComponent('tabbarjs').curr = true;
								}
		...
		// 初始化单个游戏盘
		initTrayData: function initTrayData(n) {
				var _this = this;
				var arr = [];
				...
				listB.forEach(function (v, i) {
						arr.push(new _this.Card(v, false));
				});
